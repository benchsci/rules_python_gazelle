...
def gazelle_python_manifest(
    ...
    manifest_generator_hash = Label("@com_github_benchsci_rules_python_gazelle//gazelle/manifest/generate:generate_lib_sources_hash")
    ...
    go_test(
        ...
        srcs = [Label("@com_github_benchsci_rules_python_gazelle//gazelle/manifest/test:test.go")],
        data = [
            manifest,
            requirements,
            manifest_generator_hash,
        ...
        rundir = ".",
        deps = [Label("@com_github_benchsci_rules_python_gazelle//gazelle/manifest")],
...
sources_hash = rule(
    ...
    attrs = {
        ...
        "_hasher": attr.label(
            cfg = "exec",
            default = Label("@com_github_benchsci_rules_python_gazelle//gazelle/manifest/hasher"),
            executable = True,
        ),
    },
)
